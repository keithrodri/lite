      ...
      <tr><td>
        ...
        <?php if ($ids) : foreach ($ids as $key => $value) : $image = wp_get_attachment_image_src($value); ?>
          ...
          <li style="display: block; ">
            ...
            <img class="image-preview" style="display: block; width: 100%; max-width:200px"; src="<?php echo $image[0]; ?>">
            <a class="change-image button button-small" href="#" data-uploader-title="Change image" data-uploader-button-text="Change image">Change image</a>
            <small><a class="remove-image  button button-small" href="#">Remove image</a></small>
            <br> 
          </li>
<br> 
